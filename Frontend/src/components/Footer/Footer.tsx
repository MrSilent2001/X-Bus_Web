...
const Footer = () => {
    return (
        <footer className="w-full bg-[linear-gradient(to_bottom,#FFFFFF_51%,#F5DFDD_98%,#EBCAC7_100%)] shadow-md text-red-900 py-8 px-4 md:px-20">
            <div className="container mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
                    {/* Left Side - Contact Info */}
                    <div className="text-center md:text-left">
                        <h3 className="text-2xl font-semibold py-4">Contact</h3>
                        <div className="font-regular py-2">
